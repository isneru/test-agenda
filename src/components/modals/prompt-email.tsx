...
export const PromptEmailModal = ({
	...
	return (
		<Dialog.Root open={isModalVisible} onOpenChange={toggleModal}>
			...
			<Dialog.Content className='fixed left-1/2 top-1/2 flex w-[460px] -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-4 rounded-xl shadow bg-red-950 py-6 px-8 data-[state=closed]:animate-[dialog-content-hide_200ms] data-[state=open]:animate-[dialog-content-show_200ms]'>
